        ...
        <html lang="ko">
          ...
          <body>
            ...
            <script>
              ...
              // 3초 후 창 닫기 시도 (사용자가 연 창일 경우에만 작동)
              setTimeout(() => { 
                  window.close(); 
              }, 3000);
          </script>
